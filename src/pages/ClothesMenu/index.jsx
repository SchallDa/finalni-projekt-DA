  ...
  return (
    <>
      <div className="clothesMenu_container">
        ...
        <div class="clothesMenu">
          {/* Kabát */}
          <a class="clothesMenu__item" href="#">
            <svg
              class="clothesMenu__image clothesMenu__image--pink"
              height="48"
              width="48"
            ...
            <p class="clothesMenu__text clothesMenu__text--pink">Kabát</p>
          </a>

          {/* Oblek */}
          <a class="clothesMenu__item" href="#">
            <svg
              class="clothesMenu__image clothesMenu__image--white"
              height="48"
              width="48"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
            ...
            <p class="clothesMenu__text clothesMenu__text--white">Oblek</p>
          </a>
          ...
          <a class="clothesMenu__item" href="#">
            ...
            <p class="clothesMenu__text clothesMenu__text--pink">
              Letní oblečení
            </p>
          </a>
          ...
          <a class="clothesMenu__item" href="#">
            ...
            <p class="clothesMenu__text clothesMenu__text--white">
              Pracovní oblečení
            </p>
          </a>
        </div>
