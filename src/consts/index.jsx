...
export const Clothes = {
  [CLOTHES_IDS.WOOLEN_COAT]: {
    ...
    fiberLink: 'wool',
    link: '/materialy/vlna',
    pros: 'Vlna je skvělá pro zimní oblečení. Má výborné termoizolační vlastnosti, odvádí vlhkost, nemačká se a navíc hřeje i za mokra.',
  ...
  [CLOTHES_IDS.SYNTHETIC_COAT]: {
    ...
    pros: 'Syntetické materiály jsou relativně levné a představují alternativu k dražším látkám. Umělá vlákna lze vyprodukovat v barevných odstínech, které nejsou pro přírodní materiály možné.',
    cons: 'Oděvy s vysokým podílem syntetických vláken jsou velmi málo prodyšné. Nositel se v nich brzy zapotí, což často doprovází nelibý óder. ',
  ...
  [CLOTHES_IDS.WOOLEN_SUIT]: {
    ...
    fiberLink: 'wool',
    link: '/materialy/vlna',
    pros: 'Vlna je skvělým materiálem pro obleky. Má výborné termoizolační vlastnosti, odvádí vlhkost a nemačká se. Dobře odolává otěrům na namáhaných místech a navíc hřeje i za mokra.',
  ...
  [CLOTHES_IDS.SYNTHETIC_SUIT]: {
    ...
    fiberLink: 'synthetics',
    link: '/materialy/syntetika',
    pros: 'Syntetické materiály jsou relativně levné a představují alternativu k dražším látkám. Pokud se jedná o oblek využívaný jednou ročně, syntetický materiál není na škodu.',
    cons: 'Oděvy s vysokým podílem syntetických vláken jsou velmi málo prodyšné, nositel se v nich brzy zapotí, což často doprovází nelibý óder.',
    maintenance: [
      'wash-40-degrees',
  ...
  [CLOTHES_IDS.COTTON_SUMMER_CLOTHES]: {
    ...
    eco: 'Produkce bavlny je velmi náročná na spotřebu vody, pesticidů, insekticidů i hnojiv. Palčivou otázkou jsou i životní podmínky pracovníků v bavlněném průmyslu. Vhodnější alternativou může být ekologická nebo recyklovaná bavlna.',
  },
  [CLOTHES_IDS.LINNEN_SUMMER_CLOTHES]: {
    ...
    cons: 'V porovnání s bavlněným oblečením je jednou z nevýhod vyšší cena. To je dáno především menší nabídkou lněných oděvů. Další nevýhodou je nepoddajnost vlákna. Oblečení je tak potřeba žehlit.',
    maintenance: [
      'iron-steam',
      'machine-wash-normal',
      'tumble-dry-law-temperature',
  ...
  [CLOTHES_IDS.COTTON_WORK_CLOTHES]: {
    ...
    fiberLink: 'cotton',
    link: '/materialy/bavlna',
    pros: 'Bavlněný oděv je ideální pro manuálně náročnou práci, neboť je prodyšný. Při práci s ohněm nebo chemikáliemi, bavlna, na rozdíl od syntetiky, “pouze” shoří a nedojde k seškvaření materiálu. Bavlněný oděv je tak v případě nehody lepší varianta.',
  ...
  [CLOTHES_IDS.SYNTHETIC_WORK_CLOTHES]: {
    ...
    cons: 'Oděvy s vysokým podílem syntetických vláken jsou velmi málo prodyšné, rychle se v nich zpotíme, což často doprovází nelibý óder. Při kontaktu s ohněm a chemikáliemi u nich dochází k "seškvaření", což může negativně ovlivnit případnou popáleninu na kůži.',
    maintenance: [
      'tumble-dry-law-temperature',
      'wash-40-degrees',
      'iron-medium-temperature',
...
export const MaterialDetail = {
  [MATERIALS_IDS.WOOL]: {
    ...
    con: 'Jde o materiál náročný na údržbu. Strukturou je vlněné vlákno podobné lidskému vlasu a obdobná je i péče o něj. Když se o vlasy dobře staráme, jsou krásné. Pokud ne, čeká nás matná hříva a roztřepené konečky. Stejně jako lidský vlas i vlnu pokrývají šupinky, které se o sebe během praní třou, což vede ke žmolkování.',
  ...
  [MATERIALS_IDS.COTTON]: {
    ...
    conHeader: 'Nevýhody materiálu',
    con: 'V obchodech sice najdeme výrobky s nálepkou „udržitelná bavlna“. Náročnost pěstování je ale stále jejím velkým mínusem. Během produkce bavlníku jsou často upřednostňovány zisky nad udržitelností. Rostliny je potřeba zavlažovat a dopady bývají drastické. Jde o jeden z hlavních důvodů vysychání jezer a toků v Asii. Pěstování je náročné i na hnojiva a pesticidy, které v půdě zanechávají stopy. V rozvojových zemích bavlnu místo strojů často sklízí lidé, kteří pracují v náročných podmínkách srovnatelných s otroctvím.',
    maintenanceHeader: 'Údržba',
    maintenance:
  ...
  [MATERIALS_IDS.LINEN]: {
    ...
    header: 'Len',
    intro:
      'Len je dnes přehlíženým materiálem. Ještě v minulém století byl u nás hojně pěstován a nebylo těžké sehnat z něho lokální výrobky. Nyní už se u nás  za účelem výroby vláken nepěstuje, můžeme si ale koupit výrobky z evropského lnu.',
    prosHeader: 'Výhody materiálu',
  ...
  [MATERIALS_IDS.SYNTHETIC]: {
    ...
    header: 'Umělá vlákna',
    intro:
      'Pod umělá vlákna patří spousta druhů materiálů jako polyester(PES) nebo polyamid(PA).',
    prosHeader: 'Výhody materiálu',
    pros: 'Velkou výhodou materiálu je jeho rozmanitost a to jak druhová, tak samotných vláken. Oproti přírodním vláknům, které mají daný  tvar i vlastnosti, jsou vlastnosti syntetických vláken výsledkem výrobního procesu. Je tak možné mít z jednoho druhu materiálu vlákno lesklé, matné nebo duté. Barevná stálost umělých vláken bývá dobrá.',
    conHeader: 'Nevýhody materiálu',
    ...
    maintenanceHeader: 'Údržba',
    maintenance:
      'Rozmanitá je rovněž údržba. Některé druhy materiálu mají vysokou otěruvzdornost a málo se žmolkují, jiné nízkou. Pokud má oděv dlouho vydržet, měl by se uživatel řídit cedulkou s doporučením.',
  },
};
